...
************************************************************************************************/
void D2DRenderer::RenderTextField( int  x,  int  y, std::wstring  text,  COLORREF  color,
	 int  size,  int  width,  int  height,  float  alpha,  DWRITE_TEXT_ALIGNMENT  align, std::wstring  font)
{
	POINTFLOAT pos = { x, y };
	IDWriteTextLayout* layout = nullptr;
	mDWFactory->CreateTextLayout(
